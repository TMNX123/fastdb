...
![downloads](https://img.shields.io/npm/dt/stack.db) ![version](https://img.shields.io/npm/v/stack.db?color=%2351F9C0&label=version)

<img src="https://nodei.co/npm/stack.db.png?downloads=true&downloadRank=true&stars=true">

# Installation

**Warning:** `stack.db` is requires node.js version greater than 12!
...
Also, if you want to use `stack.db` in browser

```html
<script src="https://unpkg.com/stack.db@2.6.0/dist/LocalStorage.min.js"></script>
<script>
...
```js
const { MongoDB } = require("stack.db");
...
```js
const { Database } = require("stack.db");
