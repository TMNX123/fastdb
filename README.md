...
![downloads](https://img.shields.io/npm/dt/fastdb) ![version](https://img.shields.io/npm/v/fastdb?color=%2351F9C0&label=version)

<img src="https://nodei.co/npm/fastdb.png?downloads=true&downloadRank=true&stars=true">

# Installation

**Warning:** `fastdb` is requires node.js version greater than 12!
...
Also, if you want to use `fastdb` in browser

```html
<script src="https://unpkg.com/fastdb@2.6.0/dist/LocalStorage.min.js"></script>
<script>
